...
public class RoleController {
	...
	public @ResponseBody Map<String, Object> add(Role role,BindingResult result) {
	...
	public @ResponseBody Map<String, Object> save(Role role,BindingResult result) {
		if(!result.hasErrors()){
	...
	public @ResponseBody Map<String, Object> delete(Role role) {
