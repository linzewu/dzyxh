...
public abstract class TmriJaxRpcOutNewAccessServiceCallbackHandler {
    ...
    public void receiveResultwriteObjectOutNew(
    		com.xs.dzyxh.out.service.client.TmriJaxRpcOutNewAccessServiceStub.WriteObjectOutNewResponse result) {
    }
    ...
    public void receiveResultwriteObjectOut(
    		com.xs.dzyxh.out.service.client.TmriJaxRpcOutNewAccessServiceStub.WriteObjectOutResponse result) {
    }
    ...
    public void receiveResultqueryObjectOut(
    		com.xs.dzyxh.out.service.client.TmriJaxRpcOutNewAccessServiceStub.QueryObjectOutResponse result) {
    }
    ...
    public void receiveResultqueryObjectOutNew(
    		com.xs.dzyxh.out.service.client.TmriJaxRpcOutNewAccessServiceStub.QueryObjectOutNewResponse result) {
    }
