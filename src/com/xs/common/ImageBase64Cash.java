...
public class ImageBase64Cash {
	
	public static final Integer DEFAULT_BUFFER_SIZE=1024;
	
	private static ImageBase64Cash iamgeBase64Cash;
	
	private ImageBase64Cash(){}
	
	private static String path;
	
	public static ImageBase64Cash getInstance(){
		
		if(iamgeBase64Cash==null){
			iamgeBase64Cash=new ImageBase64Cash();
			path=iamgeBase64Cash.getClass().getClassLoader().getResource("/").getFile();
			path=path.split("WEB-INF")[0]+"/images/cache/";
		}
